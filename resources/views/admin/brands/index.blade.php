            ...
            <div class="col-md-12">
                <div class="card-header">
                    <div class="card-text">
                        ...
                        @endif
                        <h2 class="text-center" style="text-transform:none">List of Brands</h2><br>
                    </div>
                    <div class="card-body bg-white">
                                ...
                                @foreach ($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <a href="{{ route('admin.brands.detail', $brand->brand_id) }}" class="btn btn-info w-100">Details</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    <a href="{{ route('admin.brands.edit', $brand->brand_id) }}" class="btn btn-warning w-100">Edit</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    <a href="{{ route('admin.brands.delete',$brand->brand_id) }}" class="btn btn-danger w-100">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div>
                        {{ $brands->withQueryString()->links("pagination.default") }}
                    </div>
                </div>
            </div>
        </div>
