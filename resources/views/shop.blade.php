                                        ...
                                        @foreach ($brands as $brand)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="br{{$brand->brand_id}}" name="brands" @if(in_array($brand->brand_id,explode(',',$q_brands))) checked="checked" @endif value="{{$brand->brand_id}}" type="checkbox" onchange="filterProductsByBrand(this)">
                                ...
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                        @foreach ($categories as $category)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="ct{{$category->category_id}}" name="categories" type="checkbox" @if(in_array($category->category_id,explode(',',$q_categories))) checked="checked" @endif value="{{$category->category_id}}" onchange="filterProductsByCategory(this)">
                            ...
                            <div class="img-wrapper">
                                ...
                                <div class="cart-wrap">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" onclick="addProductToWishlist({{ $product->product_id }},'{{ $product->name }}',1,{{ $product->regular_price }})" class="wishlist">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-6">
                <div class="subscribe-details">
                    ...
                    <h6 class="font-light">Subscribe and receive our newsletters to follow the news about our brand new Products.</h6>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        function filterProductsByBrand(category){
            var brands = "";
