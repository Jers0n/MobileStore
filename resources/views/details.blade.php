...
@push('styles')
    <link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('assets/css/styles2.css') }}">
@endpush
@section('content')
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        <div>
                                            <img src="{{ asset('assets/images/uploads/products') }}/{{ $product->image }}" class="img-fluid blur-up lazyload" alt="${{ $product->name }}">
                                        </div>
                                        @if($product->images)
                                        @php
                                        ...
                                        @foreach ($images as $image)
                                            <div>
                                                <img src="{{ asset('assets/images/uploads/products') }}/{{ $image }}"
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="{{asset('assets/images/uploads/products')}}/{{$product->image}}" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->name}}">
                                        </div>
                                        @if($product->images)
                                        @php
                                            $images = explode(',', $product->images);
                                        ...
                                        @foreach ($images as $image)
                                        <div>
                                            <img src="{{ asset('assets/images/uploads/products') }}/{{ $image }}" class="img-fluid w-100 image_zoom_cls-1 blur-up lazyload" alt="">
                                            </div>
                                        @endforeach
                                        @endif
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <div class="label-section">
                                    ...
                                    <span class="label-text">in mobile</span>
                                </div>
                                        ...
                                        <ul class="image-section">
                                            <li>
                                                <a href="javascript:void(0)">
                                                    <img src="{{ asset('assets/images/uploads/products') }}/{{ $product->image }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </li>
                                            <li>
                                ...
                                <ul class="product-count shipping-order">
                                    <li>
                                        <img src="../assets/images/gif/truck.png" class="img-fluid blur-up lazyload"
                                            alt="image">
                                        <span class="lang">Free shipping for orders above $500 AUD</span>
                                    </li>
                                </ul>
                ...
                <div class="mobile-review">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="speci">
                            <div class="pro mb-4">
                                <p class="font-light">The user is holding a mobile phone from our phone category
                                    collection, see the image for a mock-up of what the actual phone would look
                                    like. </p>
                                <div class="table-responsive">
                                    <table class="table table-part">
                                        ...
                                        <tr>
                                            <th>Weight</th>
                                            <td>{{ $feature->weight  }} g</td>
                                        </tr>
                                        <tr>
                                            <th>Product Dimensions</th>
                                            <td>{{ $feature->dimensions }} mm</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>Screensize</th>
                                            <td>{{ $feature->screensize }} inches</td>
                                        </tr>
                                        <tr>
                                            <th>Resolution</th>
                                            <td>{{ $feature->resolution }} pixels</td>
                                        </tr>
                                        <tr>
                                            <th>CPU</th>
                                            <td>{{ $feature->CPU }}</td>
                                        ...
                                        <tr>
                                            <th>Battery</th>
                                            <td>{{ $feature->battery }} mAh</td>
                                        </tr>
                                        <tr>
                                            <th>Rear camera</th>
                                            <td>{{ $feature->rear_camera }} MP</td>
                                        </tr>
                                        <tr>
                                            <th>Front camera</th>
                                            <td>{{ $feature->front_camera }} MP</td>
                                        </tr>
                                        @endforeach
                                    </table>
                                </div>
                                    ...
                                    <div class="customer-review-box">
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">I purchased my Samsung at Best Buy but I wanted
                                                    to
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">Pros: Nice large screen. Bright colors.
                                                    Easy
                                                    to setup and get started. Arrived on time. Cons: a bit slow on
                                                    response, but expected as Xiaomi is 2 generations old. But works
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">I purchased the Xiaomi May 2017 and now April
                                                    2019
